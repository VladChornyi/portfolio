  ...
  return (
    <header className="py-4">
      <div className="container flex justify-between">
        <AppLink
          className="text-3xl ease-in-out duration-300 hover:scale-125 transparent-text bg-gradient-to-r hover:bg-gradient-to-l bg-clip-text from-indigo-500 to-blue-500"
          href="/"
        >
          V4
        </AppLink>
